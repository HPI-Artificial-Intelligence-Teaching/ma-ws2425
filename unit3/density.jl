...
savefig("~/Downloads/uniform_distribution.svg")
plot_discrete_uniform_cdf(6)
savefig("~/Downloads/discrete_uniform_cdf_6.svg")
plot_uniform_distribution_cdf(1000)
savefig("~/Downloads/uniform_distribution_cdf.svg")
